  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-6">
        ...
        {/* Upload — intercept route handles modal overlay vs full page */}
        <button
          onClick={() => router.push("/request/upload")}
          className="text-xs tracking-[0.2em] uppercase transition-colors text-white/60 hover:text-white"
        >
          Upload
        </button>
