...
import inbound_pb2 as inbound__pb2
...
def add_QueueServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler("inbound.Queue", rpc_method_handlers)
