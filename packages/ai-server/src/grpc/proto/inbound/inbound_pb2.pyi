...
class ExtractOGDataResponse(_message.Message):
    ...
    site_name: str
    error_message: str
    def __init__(self, success: bool = ..., url: _Optional[str] = ..., title: _Optional[str] = ..., description: _Optional[str] = ..., image: _Optional[str] = ..., site_name: _Optional[str] = ..., error_message: _Optional[str] = ...) -> None: ...
...
class AnalyzeLinkRequest(_message.Message):
    ...
    description: str
    site_name: str
    def __init__(self, url: _Optional[str] = ..., post_id: _Optional[str] = ..., title: _Optional[str] = ..., description: _Optional[str] = ..., site_name: _Optional[str] = ...) -> None: ...
...
class ProductMetadata(_message.Message):
    ...
    origin: str
    def __init__(self, category: _Optional[str] = ..., sub_category: _Optional[str] = ..., brand: _Optional[str] = ..., price: _Optional[str] = ..., currency: _Optional[str] = ..., materials: _Optional[_Iterable[str]] = ..., origin: _Optional[str] = ...) -> None: ...
...
class ArticleMetadata(_message.Message):
    ...
    def __init__(self, category: _Optional[str] = ..., sub_category: _Optional[str] = ..., author: _Optional[str] = ..., published_date: _Optional[str] = ..., reading_time: _Optional[str] = ..., topics: _Optional[_Iterable[str]] = ...) -> None: ...
...
class VideoMetadata(_message.Message):
    ...
    view_count: str
    upload_date: str
    def __init__(self, category: _Optional[str] = ..., sub_category: _Optional[str] = ..., channel: _Optional[str] = ..., duration: _Optional[str] = ..., view_count: _Optional[str] = ..., upload_date: _Optional[str] = ...) -> None: ...
...
class OtherMetadata(_message.Message):
    ...
    sub_category: str
    content_type: str
    def __init__(self, category: _Optional[str] = ..., sub_category: _Optional[str] = ..., content_type: _Optional[str] = ...) -> None: ...

class AnalyzeLinkDirectResponse(_message.Message):
    __slots__ = ("success", "message", "summary", "keywords", "qna", "product_metadata", "article_metadata", "video_metadata", "other_metadata", "error_message")
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
    MESSAGE_FIELD_NUMBER: _ClassVar[int]
    ...
    error_message: str
    def __init__(self, success: bool = ..., message: _Optional[str] = ..., summary: _Optional[str] = ..., keywords: _Optional[_Iterable[str]] = ..., qna: _Optional[_Iterable[_Union[QAPair, _Mapping]]] = ..., product_metadata: _Optional[_Union[ProductMetadata, _Mapping]] = ..., article_metadata: _Optional[_Union[ArticleMetadata, _Mapping]] = ..., video_metadata: _Optional[_Union[VideoMetadata, _Mapping]] = ..., other_metadata: _Optional[_Union[OtherMetadata, _Mapping]] = ..., error_message: _Optional[str] = ...) -> None: ...
...
class AnalyzeImageRequest(_message.Message):
    ...
    def __init__(self, image_data: _Optional[str] = ..., item_id: _Optional[str] = ..., category_rules: _Optional[_Iterable[_Union[CategoryRule, _Mapping]]] = ...) -> None: ...
...
class CategoryRule(_message.Message):
    ...
    def __init__(self, category: _Optional[str] = ..., sub_categories: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ItemWithCoordinates(_message.Message):
    ...
    top: int
    left: int
    def __init__(self, sub_category: _Optional[str] = ..., type: _Optional[str] = ..., top: _Optional[int] = ..., left: _Optional[int] = ...) -> None: ...

class ItemList(_message.Message):
    __slots__ = ("items",)
    ITEMS_FIELD_NUMBER: _ClassVar[int]
    items: _containers.RepeatedCompositeFieldContainer[ItemWithCoordinates]
    def __init__(self, items: _Optional[_Iterable[_Union[ItemWithCoordinates, _Mapping]]] = ...) -> None: ...

class AnalyzeImageResponse(_message.Message):
    __slots__ = ("success", "subject", "title", "artist_name", "group_name", "context", "items", "error_message")
    class ItemsEntry(_message.Message):
        ...
        key: str
        value: ItemList
        def __init__(self, key: _Optional[str] = ..., value: _Optional[_Union[ItemList, _Mapping]] = ...) -> None: ...
    SUCCESS_FIELD_NUMBER: _ClassVar[int]
