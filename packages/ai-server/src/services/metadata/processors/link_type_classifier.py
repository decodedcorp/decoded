...
class LinkTypeClassifier:
    ...
    async def classify(self, url: str, title: str, description: str) -> LinkType:
        """
    ...
    def _build_classification_prompt(self, url: str, title: str, description: str) -> str:
        """분류를 위한 프롬프트 생성"""
        prompt_parts = [
    ...
    def _extract_link_type(self, response_text: str) -> LinkType:
        ...
        # 기본값: other
        self.logger.warning(
            f"Could not extract valid link_type from: {response_text}. Using 'other'"
        )
        return "other"
