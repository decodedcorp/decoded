...
class FailedItemsManager:
        ...
        try:
            ...
            if existing_data:
                ...
                if retry_item.retry_count >= self.max_retry_count:
                    await self._mark_permanent_failure(item_id, url, f"Max retries ({self.max_retry_count}) exceeded")
                    return True
            ...
            await self.redis_manager.zadd(
                ...
                {item_id: retry_item.next_retry_at}
            )
    ...
    async def complete_partial_processing(self, item_id: str, success: bool, updated_metadata: Optional[Dict[str, Any]] = None) -> bool:
        """
    ...
    def _determine_retry_targets(self, missing_fields: List[str], current_metadata: Dict[str, Any]) -> List[str]:
        """
