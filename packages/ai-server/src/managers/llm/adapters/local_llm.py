...
class LocalLLMClient(BaseLLMClient):
        ...
        **kwargs,
        ...
        try:
            ...
            if content_type == ContentType.IMAGE:
                ...
                if kwargs.get("url"):
                    return await self._handle_link_completion(
                        messages, max_tokens, temperature, **kwargs
                    )
                else:
    ...
    def health_check(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                self.logger.error(
                    f"LocalLLM health check failed (Ollama: {e}, llama-server: {fallback_e})"
                )
                return False
    ...
    async def _handle_link_completion(
        ...
        **kwargs,
        ...
        return LLMResponse(content=content, usage=usage, structured_output=result)
    ...
    async def _handle_image_completion(
        ...
        **kwargs,
        ...
        return await self._handle_text_completion(
            enhanced_messages, max_tokens, temperature, **kwargs
        )
    ...
    async def analyze_link(
        ...
        prompt = self._build_link_analysis_prompt(
            url, existing_title, existing_description, search_context
        )
    ...
    def _build_link_analysis_prompt(
        self, url: str, existing_title: str, existing_description: str, search_context: str = ""
    ) -> str:
        ...
        if search_context:
            prompt_parts.extend(["", "Additional context from web search:", search_context, ""])
        ...
        if existing_title:
            ...
            prompt_parts.append(
                "Task: Generate a clear, descriptive title for this content using all available information."
            )
        ...
        if existing_description:
            ...
            prompt_parts.append(
                "Task: Generate a comprehensive description of this content using all available information."
            )
