...
class TestLinkProcessingPipeline:
    ...
    async def test_complete_pipeline_with_good_og_tags(self, link_processor):
        ...
        with patch.object(link_processor.web_scraper, 'fetch_page') as mock_fetch:
            ...
            assert result.og_description == "This article has complete metadata with a good description."
    ...
    async def test_pipeline_with_missing_og_tags_and_enhancement(self, link_processor):
        ...
        with patch.object(link_processor.web_scraper, 'fetch_page') as mock_fetch:
            ...
            with patch.object(link_processor.perplexity_client, 'analyze_link') as mock_perplexity:
                ...
                with patch.object(link_processor.searxng_client, 'find_related_image') as mock_searxng:
                    mock_searxng.return_value = "https://example.com/enhanced-image.jpg"
                    
                    result = await link_processor.process_link("https://example.com/basic", "test-2")
                    ...
                    assert result.enhanced_description == "Enhanced description from Perplexity analysis"
        ...
        with patch.object(link_processor.web_scraper, 'fetch_page') as mock_fetch:
            ...
            with patch.object(link_processor.perplexity_client, 'analyze_link') as mock_perplexity:
                ...
                with patch.object(link_processor.searxng_client, 'find_related_image') as mock_searxng:
                    ...
                    result = await link_processor.process_link("https://example.com/partial-fail", "test-4")
                    ...
                    assert result.enhanced_image == "https://example.com/found-image.jpg"  # SearXNG worked
        ...
        with patch.object(link_processor.web_scraper, 'fetch_page') as mock_fetch:
            ...
            with patch.object(link_processor.perplexity_client, 'analyze_link') as mock_perplexity:
                ...
                with patch.object(link_processor.searxng_client, 'find_related_image') as mock_searxng:
                    ...
                    result = await link_processor.process_link("https://example.com/parallel", "test-5")
    ...
    def test_completeness_scoring_algorithm(self, link_processor):
        ...
        test_cases = [
            ...
            ("Good Title", "Good description with enough content", "https://example.com/image.jpg", "Site Name", (0.75, 1.0)),
