...
from src.database.models.batch import (
    DataItem, DataItemType, ProcessedDataBatch, LinkResult, ImageResult,
    ProcessingStatus, BatchStatistics
)
...
class TestBatchProcessor:
    ...
    @pytest.mark.asyncio
    async def test_process_batch_success(self, batch_processor, mock_link_processor, mock_image_processor, sample_items):
    ...
    @pytest.mark.asyncio
    async def test_process_batch_with_mixed_results(self, batch_processor, mock_link_processor, mock_image_processor, sample_items):
    ...
    @pytest.mark.asyncio
    async def test_process_batch_concurrency_control(self, batch_processor, mock_link_processor, mock_image_processor):
    ...
    @pytest.mark.asyncio
    async def test_process_items_parallel_with_exceptions(self, batch_processor, mock_link_processor, mock_image_processor):
        ...
        failed_result = next(r for r in result.link_results if r.processing_status == ProcessingStatus.FAILED)
    ...
    async def test_process_link_with_semaphore(self, batch_processor, mock_link_processor):
        ...
        result = await batch_processor._process_link_with_semaphore("https://example.com/test", "test-id")
    ...
    @pytest.mark.asyncio
    async def test_process_batch_error_handling(self, batch_processor, mock_link_processor, mock_image_processor):
    ...
    @pytest.mark.asyncio
    async def test_data_classification_integration(self, batch_processor, mock_link_processor, mock_image_processor):
    ...
    @pytest.mark.asyncio
    async def test_processing_time_measurement(self, batch_processor, mock_link_processor, mock_image_processor):
