...
class TestDataClassifier:
    ...
    def test_classify_items_with_mixed_content(self):
        ...
        items = [
            DataItem(item_id="1", type=DataItemType.LINK, url=HttpUrl("https://example.com/page.html")),
            DataItem(item_id="2", type=DataItemType.LINK, url=HttpUrl("https://example.com/image.jpg")),
            DataItem(item_id="3", type=DataItemType.LINK, url=HttpUrl("https://i.imgur.com/photo.png")),
            DataItem(item_id="4", type=DataItemType.LINK, url=HttpUrl("https://example.com/article")),
            DataItem(item_id="5", type=DataItemType.LINK, url=HttpUrl("https://cdn.example.com/banner.webp")),
        ]
    ...
    def test_is_image_url_by_query_params(self):
        ...
        test_cases = [
            ...
            ("https://example.com/resource?width=500&height=300", False),  # Not explicit image format
    ...
    def test_classify_all_links(self):
        ...
        items = [
            DataItem(item_id="1", type=DataItemType.LINK, url=HttpUrl("https://example.com/page1.html")),
            DataItem(item_id="2", type=DataItemType.LINK, url=HttpUrl("https://example.com/page2")),
            DataItem(item_id="3", type=DataItemType.LINK, url=HttpUrl("https://blog.example.com/post")),
        ]
    ...
    def test_classify_all_images(self):
        ...
        items = [
            DataItem(item_id="1", type=DataItemType.LINK, url=HttpUrl("https://example.com/photo1.jpg")),
            DataItem(item_id="2", type=DataItemType.LINK, url=HttpUrl("https://i.imgur.com/photo2.png")),
            DataItem(item_id="3", type=DataItemType.LINK, url=HttpUrl("https://cdn.example.com/banner.webp")),
        ]
