...
- [x] 기존 수동 API 호출 코드를 생성 코드로 교체 — Phase 41: GET 엔드포인트 전면 마이그레이션 완료, types.ts 삭제
...
_Last updated: 2026-03-23 after Phase 41 (Read Hook Migration) complete — 모든 GET 엔드포인트가 생성 훅으로 교체, types.ts 삭제 및 mutation-types.ts 분리_
