...
- [ ] Orval + Zod 코드 생성 파이프라인 구축
- [ ] 백엔드 OpenAPI spec 기반 타입/클라이언트 자동 생성
...
_Last updated: 2026-03-23 after Phase 42 (Mutation Migration) complete — 모든 mutation 훅 생성 코드로 전환, 수동 API 파일 삭제, Zustand 동기화 보존_
