...
Plans:
- [x] 53-01: `usePostDetailForImage` REST 마이그레이션 — `getPost` + `postDetailToImageDetail` adapter (DETL-01)
- [x] 53-02: `handleMaximize` soft navigation — `window.location.href` → GSAP animate-out + `router.push` (DETL-02)
...
| 51: Data Validation Gate                      | v11.0     | 1/1            | Complete      | 2026-04-01 |
| 52: Editorial Filter Fix                      | v11.0     | 2/2            | Complete      | 2026-04-01 |
| 53: Detail Data Migration                     | v11.0     | 2/2            | Complete      | 2026-04-01 |
| 54: Card Enrichment                           | v11.0     | 2/2            | Complete      | 2026-04-01 |
| 55: End-to-End Verification                   | v11.0     | 1/1            | Complete      | 2026-04-01 |
