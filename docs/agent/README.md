...
| DB summary (prod / assets 두 프로젝트, #333)   | [database-summary.md](database-summary.md)               |
| **Assets Supabase 프로젝트 설계 (#333)**       | [`../architecture/assets-project.md`](../architecture/assets-project.md) |
| Verify 플로우 수동 QA 체크리스트               | [verify-flow-qa.md](verify-flow-qa.md)                   |
...
| Warehouse 스키마 (DEPRECATED — historical reference, #333)  | [warehouse-schema.md](warehouse-schema.md)               |
